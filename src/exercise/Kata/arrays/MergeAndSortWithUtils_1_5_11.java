...
public class MergeAndSortWithUtils_1_5_11 {
    public static void main(String[] args) {
        int[] testArray_1 = {1, 3, 7, 5};
        int[] testArray_2 = {8, 4, 2, 4};
        System.out.println(Arrays.toString(mergeAndSortWithUtils(testArray_1, testArray_2)));
    }

    public static int[] mergeAndSortWithUtils (int[] firstArray, int[] secondArray) {
